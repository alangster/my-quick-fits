...
fabric.util.object.extend(fabric.StaticCanvas.prototype, /** @lends fabric.StaticCanvas.prototype */ {
  ...
  __getCroppedCanvas: function(canvasEl, cropping) {
    ...
    if (shouldCrop) {
      ...
      drawImageIOSFix(croppedCtx.canvasEl, -cropping.left || 0, -cropping.top || 0);
    }
...
(function(global) {
  ...
  fabric.Image = fabric.util.createClass(fabric.Object, /** @lends fabric.Image.prototype */ {
    ...
    applyFilters: function(callback) {
      ...
      drawImageIOSFix(canvasEl.getContext('2d'), imgEl, 0, 0, imgEl.width, imgEl.height);
...
(function(global) {
  ...
  fabric.Image.filters.Mask = fabric.util.createClass(fabric.Image.filters.BaseFilter, /** @lends fabric.Image.filters.Mask.prototype */ {
    ...
    applyTo: function(canvasEl) {
      ...
      drawImageIOSFix(maskCanvasEl.getContext('2d'), maskEl, 0, 0, maskEl.width, maskEl.height);
